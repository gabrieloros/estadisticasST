(function(){
	...
	angular
	.module('zonas')
	.controller('estadisticasZonasController', estadisticasZonasController);

	estadisticasZonasController.$inject = ['claimsService', 'empleadosService'];

	function estadisticasZonasController(claimsService, empleadosService){
		var estadisticasZonasController = this;

		estadisticasZonasController.zoneClaims = claimsService.getZoneClaims();
		estadisticasZonasController.realizadasAsignadas = getTareasRealizadasAsignadas();
    estadisticasZonasController.enTerminoFueraDeTermino = getTerminoTareas();
    estadisticasZonasController.reclamosNuevosTerminados = getReclamosNuevosTerminados();
    estadisticasZonasController.asignadasRealizadasPie = getAsignadasRealizadasPie();
    estadisticasZonasController.enTerminoFueraTerminoPie = getTerminoTareasPie();
    estadisticasZonasController.nuevasRealizadasPie = getNuevasRealizadasPie();
      ...
      var counter = 0;
			...
			_.each(estadisticasZonasController.zoneClaims, function(claim){  
    ...
    function getNuevasRealizadasPie(){
      ...
      $('#tareasRealizadas').highcharts({
        ...
        xAxis:{
          categories: estadisticasZonasController.realizadasAsignadas.days
        },
        ...
        series: [{
          ...
          data: estadisticasZonasController.realizadasAsignadas.asignadas
        }, {
          name: 'TAREAS REALIZADAS',
          data: estadisticasZonasController.realizadasAsignadas.realizadas
        }]
      });
    });
      ...
      $('#tareasTermino').highcharts({
        ...
        xAxis:{
          categories: estadisticasZonasController.enTerminoFueraDeTermino.days
        },
        ...
        series: [{
          ...
          data: estadisticasZonasController.enTerminoFueraDeTermino.enTermino
        }, {
          name: 'TAREAS FUERA DE TERMINO',
          data: estadisticasZonasController.enTerminoFueraDeTermino.fueraTermino
        }]
      });
    });        
      ...
      $('#nuevosTerminados').highcharts({
        ...
        xAxis:{
          categories: estadisticasZonasController.reclamosNuevosTerminados.days
        },
        ...
        series: [{
          ...
          data: estadisticasZonasController.reclamosNuevosTerminados.nuevos
        }, {
          name: 'RECLAMOS TERMINADOS',
          data: estadisticasZonasController.reclamosNuevosTerminados.terminados
        }]
      });
    }); 
    ...
    $(function() {
          $('#pieTareasRealizadas').highcharts({
            ...
            title: {
              text: 'RECLAMOS ASIGNADOS RRECLAMOSS REALIZADOS'
            },
            tooltip: {
            ...
            series: [{
              ...
              data: [{
                name: 'Tareas Asignadas',
                y: estadisticasZonasController.asignadasRealizadasPie.asignadas
              }, {
                name: 'Tareas Realizadas',
                y: estadisticasZonasController.asignadasRealizadasPie.realizadas
        ...
        $(function() {
          $('#pieTareasTermino').highcharts({
            ...
            title: {
              text: 'RECLAMOS EN TÉRMINO RECLAMOS FUERA DE TÉRMINO'
            },
            tooltip: {
            pointFormat: '{series.name}: <b>{point.y:,.0f}</b>'
            },
            ...
            series: [{
              ...
              data: [{
                name: 'EN TERMINO',
                y: estadisticasZonasController.enTerminoFueraTerminoPie.enTermino

              },
              {
                name: 'FUERA TERMINO',
                y: estadisticasZonasController.enTerminoFueraTerminoPie.fueraTermino
              }]
            }]
          });
        });
          ...
          $('#pieReclamos').highcharts({
            ...
            series: [{
              ...
              data: [{
                ...
                y: estadisticasZonasController.nuevasRealizadasPie.nuevos
              }, {
                name: 'Reclamos terminados',
                y: estadisticasZonasController.nuevasRealizadasPie.realizados
